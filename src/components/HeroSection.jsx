...
export default function HeroSection() {
  ...
  const developer = content.hero;
  const [firstName = developer.name, secondName = ''] = developer.name.split(' ');
            ...
            <div className="flex flex-col gap-8">
              ...
              >
                ...
                <span className="font-mono text-[11px] tracking-[0.3em] uppercase text-primary">
                  {developer.welcomePrefix} {firstName}
                </span>
              </motion.div>
              ...
              >
                {firstName} <span className="italic text-primary">{secondName}</span>
              </motion.h1>
              ...
              >
                ...
                >
                  <Mail size={14} />
                  {developer.primaryCtaLabel}
                  <motion.span className="inline-block" whileHover={{ x: 4 }} />
                </a>
                <a
                  href={developer.secondaryCtaHref}
